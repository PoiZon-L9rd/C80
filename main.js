...
function submit()
{
    ...
    {
        display_student_array.push("<h5>NAME - "+ name_of_the_student_array[k] + '</h4>');
...
function new_update() { document.getElementById("display_name_without_commas").innerHTML = "<h1>" + name_of_the_student_array +"</h1>"; }